...
def atom_to_feature_vector(atom):
    ...
    atom_feature = [
        ...
        safe_index(allowable_features['possible_is_aromatic_list'], str(atom.GetIsAromatic())),
        safe_index(allowable_features['possible_is_in_ring_list'], str(atom.IsInRing())),
    ]
    return atom_feature
